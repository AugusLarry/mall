                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <label for="config[open_member]" class="radio-inline">
                                <input type="radio" class="icheck" name="config[open_member]" value="1"> 开启
                            </label>
                            <label for="config[open_member]" class="radio-inline">
                                <input type="radio" class="icheck" checked="" name="config[open_member]" value="0"> 关闭
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea name="config[member]" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <label for="config[open_hotel]" class="radio-inline">
                                <input type="radio" class="icheck" name="config[open_hotel]" value="1"> 开启
                            </label>
                            <label for="config[open_hotel]" class="radio-inline">
                                <input type="radio" class="icheck" checked="" name="config[open_hotel]" value="0"> 关闭
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea name="config[hotel]" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <label for="config[open_shop]" class="radio-inline">
                                <input type="radio" class="icheck" name="config[open_shop]" value="1"> 开启
                            </label>
                            <label for="config[open_shop]" class="radio-inline">
                                <input type="radio" class="icheck" checked="" name="config[open_shop]" value="0"> 关闭
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea name="config[shop]" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
