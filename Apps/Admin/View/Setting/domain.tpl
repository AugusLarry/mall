            ...
            <div class="panel-body">
                ...
                <form action="{:U('Admin/Setting/save')}" mini-form="commit" class="form-horizontal form-border" role="form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="config[tuan]" class="form-control">
                        </div>
                        <div class="col-sm-3">留空表示不启用， 填写的域名必须是网站设置的根域名的子域名</div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="config[company]" class="form-control">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="config[shop]" class="form-control">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="config[holddomain]" class="form-control" value="www|*admin*|shop|hotel|mall|*blog*|*space*|*bbs*">
                        </div>
